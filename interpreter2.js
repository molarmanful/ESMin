...
[math,String,Array,Number,Object,JSON,RegExp,XRegExp,Date,_,s,window,Function,Ƈ].map(v=>Object.getOwnPropertyNames(v).map((x,y)=>v[String.fromCharCode(y+248)]=v[x]));
