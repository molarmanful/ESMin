...
Stack: Ξ ᵖ ᵍ ʳ ᶜ
Const: ị ʉ ℇ ɸ π τ ⊨ ⊭ ᕠ
Built: ש М Ϛ ᶊ Ѧ Ѩ П ɲ Ø ʝ ɼ Ɽ ᶂ ᶁ ß Ꝉ ᶏ ª ε ë Ɱ Յ փ ᵴ ᶐ ᶛ Ƈ ℹ
Basic: ⊕ ¤ ₙ ᶉ …
Paren: ⸩ ⁽ ⎛ ⎝ ⎞ ⦅ ⦆ ⟨ ⟦ ⟬ ⁅ ⦌ “ ” ‘ ’ ⍘ ⬮ ⬯ ⬭ ⬬ ⦃ 
Block: ɘ э Э ⏖ ⏜ ⏝ ⟮ ⟯ Ⅰ Ⅱ Ⅲ ᶈ
Funcs: ⓑ ⓧ Ⓒ ⒞ ⨭ ⨴ ⸮ ⁇ ⁉ ⩥ ⓜ ⒨ Ⓐ ⓢ ⓕ ⒡ Ⓕ Ｆ Ⓘ ⒤ ⓡ ⒭ ⓔ ⒠ Ⓢ ⒮ ⨝ ⌊ ⌙ ⌈ ᴙ ᴚ Ｄ
...
Num's: ² ³ ⁿ √ ∛ ¼ ½ ¾ ⅐ ⅑ ⅒ ⅓ ⅔ ⅕ ⅖ ⅗ ⅘ ⅙ ⅚ ⅛ ⅜ ⅝ ⅞ ᶀ ᶍ`,
//all the chars
		ɕ=`ïîíìᴉôⅩℍ𝕜𝕄𝔾𝕋ℙ𝔼ℤ𝕐Ξᵖᵍʳᶜịʉℇɸπτ⊨⊭ᕠשМϚᶊѦѨПɲØʝɼⱤᶂᶁßꝈᶏªεëⱮՅփᵴᶐᶛƇℹ⊕¤ₙᶉ…⸩⁽⎛⎝⎞⦅⦆⟨⟦⟬⁅⦌“”‘’⍘⬮⬯⬭⬬⦃ɘэЭ⏖⏜⏝⟮⟯ⅠⅡⅢᶈⓑⓧⒸ⒞⨭⨴⸮⁇⁉⩥ⓜ⒨Ⓐⓢⓕ⒡ⒻＦⒾ⒤ⓡ⒭ⓔ⒠Ⓢ⒮⨝⌊⌙⌈ᴙᴚＤ⇏↛↪⤤⇝⇀→⩄﹩❛❜⑴⑵⑶⊙⎖α𝚨𐄫ᶌ␤␉⑊⌿⍀˖⧺˗‡×÷٪«≪»≫⫸⋙˜⍜⇔‼≔≠≤≥⅋∧⋎∨⊻↺↻²³ⁿ√∛¼½¾⅐⅑⅒⅓⅔⅕⅖⅗⅘⅙⅚⅛⅜⅝⅞ᶀᶍ`;
...
var Σ=c=>{
	var 
			//- functions
			r='ᵖᵍʳôℹɘϚѦПØѨɼⱤƒᶁɲɟⱮᴙՄᶊëßᶏ\\u00f8-\\u0236',
